...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>IncolaBot - createbar_itwikiversity.txt</title>
  ...
  <body>
    ...
    <h3>Log of createbar_itwikiversity.py</h3>

    <pre class="txt" style="font-family:monospace;"><?php echo file_get_contents( "../log/createbar_itwikiversity.txt" ); ?></pre>
